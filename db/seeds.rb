...
20.times do 
  Doctor.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, specialty: arr_specialty.sample, zip_code: "#{Faker::Number.number(digits: 5)}")
...
200.times do
  ...
  Appointment.create(doctor: doctor_id, patient: patient_id)
end